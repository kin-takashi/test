					...
					<div class="page-product-list--item--meta">
						<div class="product-meta-1">
							<span class="product-code">
								<?php 
									if (count($productMeta["code"]) > 0):echo $productMeta["code"][0];  endif; 
								?>
							</span>
							<span class="product-size">
								<?php 
									if (count($productMeta["size"]) > 0):echo $productMeta["size"][0]; endif; 
								?>
							</span>
						</div>
...
<!--  vong lap cho nay-->
			<div class="page-product-list--item">
        <a class="product-thumbnail" href="link_den_trang_chi_tiet" aria-hidden="true" tabindex="-1">
               </a>
        <div class="page-product-list--item--meta">
            <div class="product-meta-1">
                <!-- Thông tin mã sản phẩm (nếu có) -->
            </div>
